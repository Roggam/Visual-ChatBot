...
public class UserController {
    ...
    public ModelAndView chat(@Validated ChatConversion requestedChat, BindingResult bindingResult) throws IOException {
        ...
        Map<String, QueryResult> queryResultMap = dialogFlowClient.detectIntentTexts("vc-agent-powj", Arrays.asList(requestedChat.getQuestion()), "keerthana_srinivasan", "en-US");
